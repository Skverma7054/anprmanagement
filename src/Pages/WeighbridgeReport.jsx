      ...
      <Grid container sx={{ display: "flex", justifyContent: "space-between" }}>
        <Grid item>
          <Card
            ...
            elevation={6}
          >
            <Typography>Weighbridge Report</Typography>
          </Card>
        </Grid>
        <Grid item>
          <Toolbar>
        ...
        <Table>
          <TableHead sx={{ backgroundColor: "#e0f7fa" }}>
            ...
            <TableRow>
              ...
              <TableCell>Weight Of Vehicle(Entry Gate)</TableCell>
              <TableCell>Weight Of Vehicle(Exit Gate)</TableCell>
          ...
          <TableBody>
            {filteredTruckData.map((truck, index) => (
              ...
              >
                ...
                <TableCell>{truck.entryWeight}</TableCell>
                <TableCell>{truck.exitWeight}</TableCell>
